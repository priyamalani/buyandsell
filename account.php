	...
	<body>
     ...
     <?php include 'includes/shoppingCart.php'; ?>
      ...
      <div class="page-title">
         <div class="container">
            <h2><i class="icon-desktop color"></i> <?echo $_SESSION['name'];?> <small> Account ID: <? echo $_SESSION['id'];?></small></h2>
            <hr>
         </div>
      </div>
      <!-- Page title -->
                     ...
                     <table class="table table-striped tcart">
                        ...
                        <?php
                             ...
                             echo '<tr>
                                ...
                                <td id="'.$result[$i]['product_no'].'" class="editItem"><a href="edit-ad.php?product_id='.$result[$i]['product_id'].'"><i class="icon-pencil"></i></a></td>
