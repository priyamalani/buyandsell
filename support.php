...
<html>
	...
	<body>
      ...
      <!-- Shopping cart Modal -->
     <?php include 'includes/shoppingCart.php'; ?><!-- /.modal -->
      ...
      <div class="page-title">
         <div class="container">
            <h2><i class="icon-desktop color"></i> Support <small>Subtext for header</small></h2>
            <hr>
         </div>
      </div>
      <!-- Page title -->
                              ...
                              <!-- Lists -->
                                            <ol id="slist">
                                                ...
                                                <li>
                                                   ...
                                                   <!-- Para -->
                                                   <p>Fusce imperdiet, 
risus eget viverra faucibus, diam mi vestibulum libero, ut vestibulum 
tellus magna nec enim. Nunc dapibus varius interdum. Phasellus at lorem 
ut lectus fermentum convallis. Sed diam nisi, pulvinar vitae molestie 
hendrerit, venenatis eget mauris. Integer porta erat ac eros porta 
ultrices. Proin porttitor eros a ante molestie gravida commodo dui 
adipiscing.</p>
                                                </li>
                                                <!-- List #2 and so on.... -->
                                                <li>
