                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="my_carousel">
                           ...
                           <div style="display: block; text-align: start; float: none; position: relative; top: auto; right: auto; bottom: auto; left: auto; z-index: auto; width: 1020px; height: 458px; margin: 0px; overflow: hidden;" class="caroufredsel_wrapper"><ul style="text-align: left; float: none; position: absolute; top: 0px; right: auto; bottom: auto; left: 0px; margin: 0px; width: 4080px; height: 458px;" id="carousel_container"><li style="width: 245px;">
                                 ...
                                 <a href="#"><img src="images/3.png" alt="" class="img-responsive"></a>
                                 <div class="carousel_caption">
