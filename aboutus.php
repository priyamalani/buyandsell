                    ...
                    <div class="form">
                      ...
                      <form class="form-inline" role="form">
                       <div class="form-group">
                         <input class="form-control" id="search" placeholder="Type..." type="email">
                       </div>
...
elit. Esuada fames ac turpis egestas. Suspendisse porttitor luctus 
imperdiet. <a href="#">Praesent ultricies</a> enim ac ipsum aliquet pellentesque. </p>
                  <br>
...
Phasellus condimentum rutrum aliquet.  Vivamus diam diam, fermentum sed 
dapibus eget, egestas sed eros. Lorem ipsum dolor sit amet, consectetur 
adipiscing elit.</p>
                  <br>
               </div>
            ...
            <div class="about-team">
               <h3><i class="icon-group color"></i> Our Team</h3>
               <hr>
                           ...
                           <div class="col-md-3 col-sm-3 col-xs-6">
                              ...
                              <div class="staff">
                                 ...
                                 <div class="details">
                                    ...
                                    <!-- Description -->
                                    <p class="adesc">Praes at tellus in  ligula porttitor nisl porttitor sagittis. Mauris in massa ligula, a tpor in massa ligula nulla. </p>
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-3 col-sm-3 col-xs-6">
