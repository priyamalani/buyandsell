            ...
            <div class="row">
                  <div class="col-md-5">
                           <div class="posts">
                              ...
                              <!-- Post one -->
                              <div class="entry">
                                 <h2><a href="blogsingle.php">Sed justo sceleque ut constur sceisque</a></h2>
...
arcu.</p>
                                 ...
                                 <!-- Read more -->
                                 <a href="blogsingle.php" class="btn btn-info">Read More...</a>
                              </div>
                              
                              <!-- Post 2 -->
                              <div class="entry">
                                 <h2><a href="blogsingle.php">Ut commo ullarper risus ceue mattis</a></h2>
                                 ...
                                 <h4>Search</h4>
                                    <form class="form-inline widget-search" role="form">
                                      <div class="form-group">
                                        <input class="form-control" id="exampleInputEmail2" placeholder="Type..." type="email">
                                      </div>
                          ...
                          <!-- Sidebar 2 -->
                           <div class="sidebar">
                              ...
                              <div class="widget">
                                 ...
                                 <p>Nulla facilisi. Sed justo dui, id 
erat. Morbi auctor adipiscing tempor. Phasellus condimentum rutrum 
aliquet. Quisque eu consectetur erat.  </p>
                              </div>                              
                           </div>                                                
                        </div>
    </div>
