...
if (isset($_POST['name'], $_POST['sellingPrice'],$_POST['category'],$_POST['imageFile1'])) {
   ...
   if (empty($error_msg)) {
        ...
        "('$name', '$description', '$actualPrice', '$sellingPrice', 1, '$returnPolicy', '$imageFile1', '$imageFile2', '$imageFile3', '$quantity', '$estimatedDelivery', '$shippingCharges', '$moreDetails', '$product_id', '$mem_id')"; 
